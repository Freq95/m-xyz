...
const protectedRoutes = ['/feed', '/post', '/profile', '/settings', '/notifications', '/messages', '/admin'];

// Allowed redirect paths (must be internal routes)
const allowedRedirectPaths = ['/feed', '/post', '/profile', '/settings', '/notifications', '/messages', '/onboarding', '/admin'];
